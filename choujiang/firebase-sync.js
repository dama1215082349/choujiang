...
function checkServerMode() {
    ...
    isServerMode = currentUrl.includes('localhost:8080') || currentUrl.includes('127.0.0.1:8080');
...
/**
 * Load scores from SAVED_SCORES (defined in scores-data.js)
 */
function loadSavedScores() {
    // First try the pre-loaded SAVED_SCORES
